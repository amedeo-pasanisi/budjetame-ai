...
/** Default map center when nothing is picked yet (Europe/Rome). */
...
/** A tap-to-pick map (OpenStreetMap tiles, no API key). The chosen coordinates
 * are reported via `onPick`; the marker follows `position`. */
